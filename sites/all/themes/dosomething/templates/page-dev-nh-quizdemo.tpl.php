...
<body class="<?php print $classes; ?>" style="background: white;">
<?php drupal_add_css('nd/projects/quiz.css'); ?>

<?php drupal_add_js('nd/projects/codes.js'); ?>
<?php drupal_add_js('nd/projects/quiz2.js'); ?>

<div id="quiz-container">
<div id="quiz-window">
    <form action="#" id="quiz-questions">
    </form>
  </div>

<a href="#" id="left" class="arrow left">Previous</a>
<a href="#" class="arrow right">Next</a>
<a href="#" id="quiz-end">GET RESULTS</a>
</div>
