...
<head>
  ...
  <?php print $head; ?>
  <?php print $styles; ?>
  <link rel="stylesheet" href="/<?=$ds_micro.'/expert-corps/expert-corps.css';?>" type="text/css" media="all" />
...
<body class="<?php print $classes; ?>">
  ...
  <? print str_replace('/sites/all/themes/dosomething/images/logo.png', '/sites/all/micro/greenyourschool/images/ds-logo.png', theme('header', array( 
	...
	<a href="/expert-corps"><img id="campaign-logo" src="/<?=$ds_micro;?>/expert-corps/expert-corps-logo.png" /></a>
