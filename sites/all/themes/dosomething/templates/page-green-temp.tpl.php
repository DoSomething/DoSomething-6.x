...
<head>
  ...
  <meta property="og:url" content="http://www.dosomething.org/green-temp" />
...
<body class="<?php print $classes; ?>">
  ...
  <? print str_replace('/sites/all/themes/dosomething/images/logo.png', '/sites/all/micro/greenyourschool/images/ds-logo.png', theme('header', array( 
    ...
    <a href="/green-temp"><img id="campaign-logo" src="/<?=$ds_micro;?>/greenyourschool/images/gys-logo.png" /></a>
    <div id="greener-subheader">Got what it takes to go <span style="color: #78c848;">greener</span> than the competition? Prove it.</div>
	 ...
	 <div id="block-webform-client-block-735506">
        <?php $sign_up = module_invoke('webform', 'block', 'view', 'client-block-735506');
...
<a href="#"><div class="small-button center">VIEW IDEAS</div></a>
</div>
</div>
...
<a href="#"><div class="small-button center">CHECK IT OUT</div></a>
</div>
</div>
...
<a href="#"><div class="small-button center">VIEW SCHOOLS</div></a>
</div>
</div>
