...
<head>
  ...
  <?php print $styles; ?>
  <?php print $scripts; ?>
  <script type="text/javascript" src="http://www.dosomething.org/sites/all/micro/membership/membership.js"></script>
  <link type="text/css" rel="stylesheet" media="all" href="http://www.dosomething.org/sites/all/micro/membership/membership.css" />
</head>

<body class="<?php print $classes; ?>">

  <div id="page-wrapper"><div id="page">
  <? print str_replace('/sites/all/themes/dosomething/images/logo.png', '/sites/all/micro/membership/logo.png', 
                        theme('header', array(
