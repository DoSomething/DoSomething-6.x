...
<head>
  ...
  ?>
  	...
  	<?php endif; ?>
  <meta property="og:image" content="http://www.dosomething.org/sites/all/micro/sports-beta/fb-share.png" />
  <?php endif; ?>
  <link rel="stylesheet" href="/<?=$ds_micro.'/sports-beta/sports.css';?>" type="text/css" media="all" />
  <?php print $scripts; ?>
  <script type="text/javascript" src="/<?=$ds_micro.'/sports-beta/sports.js';?>"></script>
</head>
...
<body class="<?php print $classes; ?>">
  ...
  <? print theme('header', array(
    ...
    <div id="give-us-your-gear" class="college"><span class="orange">Great job!</span><br />10,000 Pieces Collected</div>
    ...
    <div id="sports">
     ...
     <a href="/sports-beta"><img id="sports-logo" src="/<?=$ds_micro;?>/sports-beta/logo.png" /></a>
     ...
     <div id="sports-nav">
      <img src="/sites/all/micro/sports-beta/arrow-top.png" id="arrow-top" />
      <img src="/sites/all/micro/sports-beta/arrow-bottom.png" id="arrow-bottom" />
      <?php
        $base = '/sports-beta';
