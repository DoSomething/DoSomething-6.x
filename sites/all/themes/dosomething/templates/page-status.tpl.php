...
<head>
  ...
  <meta property="og:url" content="http://www.dosomething.org/status" />
  <meta property="og:image" content="http://www.dosomething.org/sites/all/micro/hiv/images/hiv-fb.png" />
  <meta property="og:site_name" content="Update Your Status | DoSomething.org"/>
  <meta property="og:description" content="1 in 5 Americans with HIV doesn't know they have it. Update Your Status with DoSomething.org and share this with your friends."/>
...
<body class="<?php print $classes; ?>">
  ...
  <? print str_replace('/sites/all/themes/dosomething/images/logo.png', '/sites/all/micro/tfj-full/images/ds-logo.png', theme('header', array( 
    ...
    <a href="/status"><img id="hiv-logo" src="/<?=$ds_micro;?>/hiv/images/hiv-logo.png" /></a>
	<a href="/status/tell-us"><img id="get-swag" src="/<?=$ds_micro;?>/hiv/images/get-swag.png" /></a>
...
<div class="fb-like" data-href="http://dosomething.org/status" data-send="false" data-layout="box_count" data-width="50px" data-show-faces="false"></div> 	<!-- TEENS FOR JEANS WIDTH/HEIGHT = 60/90 SRC, 50/62 HTML -->
