...
<head>
  ...
  <?php print $head; ?>
  <?php print $styles; ?>
  <link rel="stylesheet" href="/<?=$ds_micro.'/tackle-hunger/th-test.css';?>" type="text/css" media="all" />
  <link rel="stylesheet" href="/<?=$ds_micro.'/tackle-hunger/fonts.css';?>" type="text/css" media="all" />
  <?php print $scripts; ?>
</head>
...
<body class="<?php print $classes; ?>">
  ...
  <? print theme('header', array( 
    ...
    <div id="tackle-hunger">
     ...
     <img id="tackle-hunger-logo" src="/<?=$ds_micro;?>/tackle-hunger/tackle-hunger-logo.png" />
      <?php print $messages; ?>
