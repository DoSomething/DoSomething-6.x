...
(function(){var k='3325165719',d=document,l=d.location,c=d.cookie;function f(n){
...
<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['gwo._setAccount', 'UA-493209-11']);
    _gaq.push(['gwo._trackPageview', '/3325165719/test']);
    (function() {
...
<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['gwo._setAccount', 'UA-493209-11']);
    _gaq.push(['gwo._trackPageview', '/3325165719/goal']);
    (function() {
          var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async = true;
              ga.src = ('https:' == document.location.protocol ? 'https://ssl' : 'http://www') + '.google-analytics.com/ga.js';
              var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
  ...
  <? print theme('header', array(
    ...
    <div id="main-wrapper" class="clearfix"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <?php if ($title && !in_array($node->type, array('page', 'chatterbox', 'campaign_ebd_2011', 'celebs_gone_good'))): ?>
